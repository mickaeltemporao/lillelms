# J2 matin (CV) — Idées de l'IA générative
...
- Cloud opérationnel (Colab / Onyxia)
- Bases Python + pandas
- Première exposition à `google-colab-ai`

## Déroulé

| Créneau | Durée | Bloc |
|---|---|---|
| 9h00-9h15 | 15' | Accueil + amorce sur les représentations de l'IA |
| 9h15-9h45 | 30' | Mise en perspective historique : IA → ML → DL → Transformers → LLM → IA générative |
...
- Niveau Python hétérogène (25 % Python, 14 % aucun outil) → Colabs « à trous » : les avancés explorent plus loin, les novices remplissent les cellules TODO
- Cas concrets puisés dans les motivations des participants (cf. `participants/analyse_des_participants.md`)
- Enjeux éthiques et biais abordés de manière **transversale** au fil des blocs (notions, démos, carrousel), pas dans un créneau dédié
